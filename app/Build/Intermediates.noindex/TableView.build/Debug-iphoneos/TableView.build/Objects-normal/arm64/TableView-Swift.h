...
@interface Album (SWIFT_EXTENSION(TableView))
...
SWIFT_CLASS("_TtC9TableView26AlbumDetailsViewController")
...
SWIFT_CLASS_NAMED("Artist")
@interface Artist : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface Artist (SWIFT_EXTENSION(TableView))
- (void)addAlbumObject:(Album * _Nonnull)value;
- (void)removeAlbumObject:(Album * _Nonnull)value;
- (void)addAlbum:(NSSet * _Nonnull)values;
- (void)removeAlbum:(NSSet * _Nonnull)values;
@end
...
@property (nonatomic, strong) NSSet * _Nullable album;
@end
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tfArtistName;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lblFoundArtistName;
@property (nonatomic, weak) IBOutlet UIActivityIndicatorView * _Null_unspecified spinner;
- (void)viewDidLoad;
- (IBAction)goPressed:(id _Nonnull)sender;
- (IBAction)searchPressed:(id _Nonnull)sender;
- (IBAction)changePressed:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9TableView18MenuViewController")
@interface MenuViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lblArtistName;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (IBAction)savedPressed:(id _Nonnull)sender;
- (IBAction)itunesPressed:(id _Nonnull)sender;
...
@interface Track (SWIFT_EXTENSION(TableView))
@property (nonatomic, copy) NSString * _Nullable title;
@property (nonatomic) int16_t trackNo;
@property (nonatomic, strong) Album * _Nullable album;
@end


SWIFT_CLASS("_TtC9TableView10customCell")
